...
class MoveBaseSquare():
    def __init__(self):
        ...
        waypoints.append(Pose(Point(10, -0.8, 0.0), quaternions[0]))
        waypoints.append(Pose(Point(10, 0.8, 0.0), quaternions[1]))
        waypoints.append(Pose(Point(-10, 0.8, 0.0), quaternions[2]))
        waypoints.append(Pose(Point(-10, -0.8, 0.0), quaternions[3]))
