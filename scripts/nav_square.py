...
class NavSquare():
    def __init__(self):
        ...
        goal_distance = rospy.get_param("~goal_distance", 20)      # meters
        ...
        for i in range(4):
            ...
            while distance < goal_distance and not rospy.is_shutdown():
                ...
                # x+
                if i == 0: 
                    move_cmd.angular.z = -(position.y-y_start)-(position.y-pre_y)/0.01
                # y+
                elif i == 1:
                    move_cmd.angular.z = (position.x-x_start)+(position.x-pre_x)/0.01
                # x-
                elif i == 2:
                    move_cmd.angular.z = (position.y-y_start)+(position.y-pre_y)/0.01
                # y+
